...
init_screen_comp <- read_csv("../csv_files/collection_tax_data.csv") |>
  select(Isolate,asv, host_species, log_auc_norm, Effect, ccEffect, grEffect) |>
...
corr <- cor_test(data = init_screen_comp, select(where(~select(mean_log_auc_norm_Original + log_auc_norm))), method = "pearson")
init_screen_comp |>
